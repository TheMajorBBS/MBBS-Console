...
import 'console_full_model.dart';
export 'console_full_model.dart';

class ConsoleFullWidget extends StatefulWidget {
  const ConsoleFullWidget({super.key});

  @override
  State<ConsoleFullWidget> createState() => _ConsoleFullWidgetState();
}

class _ConsoleFullWidgetState extends State<ConsoleFullWidget> {
  late ConsoleFullModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsoleFullModel());
